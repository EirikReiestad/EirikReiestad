"""
Inspirated from: https://github.com/Andrew6rant/Andrew6rant/blob/main/today.py
"""
...
USER_NAME = os.environ["USER_NAME"]  # EirikReiestad
...
def svg_overwrite(
    ...
    if len(age_data) == 28:
        ...
        age_data_length = 47
    justify_format(root, "age_data", age_data, age_data_length)
...
if __name__ == "__main__":
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2001, 4, 30))
